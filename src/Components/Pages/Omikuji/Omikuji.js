      ...
      <div id="randomBackGround">
        <div className={styles["omikuji"]}>
          <div className={styles["contents"]}>
            <button onClick={() => window.location.reload()} className={styles["refresh-btn"]}><span id="refresh-icon" className="material-icons">refresh</span></button>
